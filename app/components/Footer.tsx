...
const socialLinks = [
  ...
  },
  {
    ...
    label: "TikTok",
    icon: "M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.46v-7.15a8.16 8.16 0 005.58 2.17v-3.45a4.85 4.85 0 01-2-.54z",
  },
];
    ...
    <div className={`flex gap-2 md:gap-3 ${className || ""}`}>
      {socialLinks.map((s) => (
        <a
          ...
          aria-label={s.label}
          className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-gray-400 hover:text-[#dffd6e] hover:border-[#dffd6e] transition"
        >
...
export default function Footer() {
  return (
    <footer className="relative bg-black border-t border-zinc-800/50 py-10 md:py-16 px-6">
      <div className="max-w-7xl mx-auto">
        {/* Desktop: 4-col grid | Mobile: compact layout */}
        ...
        <div className="md:hidden mb-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <Link href="/" className="inline-flex flex-col items-center">
              ...
              <span className="text-xs text-gray-400 font-extralight tracking-[0.25em] -translate-x-[3px]">
                AUTO BOUTIQUE
              </span>
            </Link>
            <SocialIcons />
          ...
          {/* 3 link columns inline */}
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <h3 className="text-white text-xs font-normal tracking-wider mb-3 uppercase">Company</h3>
            ...
            <div>
              <h3 className="text-white text-xs font-normal tracking-wider mb-3 uppercase">Services</h3>
              <ul className="space-y-2">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <Link href="/" className="inline-flex flex-col items-center mb-6">
              ...
              <span className="text-sm text-gray-400 font-extralight tracking-[0.25em] -translate-x-[3px]">
                AUTO BOUTIQUE
              </span>
            </Link>
        ...
        {/* Bottom Bar */}
        <div className="pt-6 md:pt-8 border-t border-zinc-800/50">
