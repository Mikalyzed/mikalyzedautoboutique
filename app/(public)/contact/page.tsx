                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <div className="flex gap-4 mt-2">
                      ...
                      <a href="https://www.youtube.com/@mikalyzedautoboutique" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-gray-400 hover:text-[#dffd6e] hover:border-[#dffd6e] transition">
