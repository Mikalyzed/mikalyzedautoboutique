    ...
    <>
      <div className="flex flex-col gap-3 mb-10">
        <div className="flex gap-2 sm:gap-3">
          ...
          {!isAuction && (
            <a
              href="https://dwssecuredforms.dealercenter.net/CreditApplication/index/22887597?themecolor=8C8C8C&formtype=s&frameId=dws_frame_0&standalone=true&ls=Our Website"
              target="_blank"
              rel="noopener noreferrer"
