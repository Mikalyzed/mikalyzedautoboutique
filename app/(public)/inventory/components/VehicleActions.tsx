    ...
    <>
      <div className="flex flex-col gap-3 mb-10">
        <div className="flex gap-2 sm:gap-3">
          ...
          <div className="flex-1 relative" ref={contactRef}>
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 sm:gap-2 bg-[#dffd6e] text-black px-3 py-2.5 sm:px-6 sm:py-3 rounded-lg text-sm sm:text-base font-normal tracking-wide hover:bg-[#dffd6e]/90 transition"
            >
          ...
          <button
            ...
            className="bg-black border border-zinc-700 text-white p-2.5 sm:p-3 rounded-lg hover:border-[#dffd6e] transition"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-black border border-[#dffd6e] text-[#dffd6e] px-6 py-3 rounded-lg font-light tracking-wider hover:bg-[#dffd6e] hover:text-black transition-all duration-300"
        >
